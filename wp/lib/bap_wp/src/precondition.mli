...
val lookup_sub : Bap.Std.Label.t -> Constr.t -> Env.t -> Constr.t
...
val new_z3_expr : ?name:string -> Env.t -> Bap.Std.Type.t -> Constr.z3_expr

(** Translate a BAP BIR variable to a Z3 expression (by creating a constant of the same name). *)
val var_to_z3 : Z3.context -> Bap.Std.Var.t -> Constr.z3_expr
...
val exp_to_z3 : Bap.Std.exp -> Env.t -> Constr.z3_expr * Constr.t list * Constr.t list
...
val visit_jmp : Env.t -> Constr.t -> Bap.Std.Jmp.t -> Constr.t
