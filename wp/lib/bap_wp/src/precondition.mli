...
val create_uninterp : string list -> Z3.context -> Env.op_spec

(** The default value of op_spec. Here all operations will remain interpreted. *)
val op_spec_default : Env.op_spec
...
(** Creates an environment with
    ...
    - the default {!Environment.op_spec} that specifies how a binop will be interpreted
